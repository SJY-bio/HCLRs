...
base_dirs <- c(
  "D:/ATAC/HCLRs/GSE127465/CellChat",
  "D:/ATAC/HCLRs/GSE127465/CellphoneDB",
  "D:/ATAC/HCLRs/GSE127465/Nichenet",
  "D:/ATAC/HCLRs/GSE127465/Scriabin",
  "D:/ATAC/HCLRs/GSE179572/commot",
  "D:/ATAC/HCLRs/GSE179572/NICHES",
  "D:/ATAC/HCLRs/GSE179572/stlearn"
)

# initialize result data frame
all_final_results <- data.frame()

# loop through each base_dir
for (bd in base_dirs) {
  base_dir <- bd
...
all_final_results$Group <- ifelse(all_final_results$Algorithm %in% c("CellChat", "CellphoneDB", "Nichenet", "Scriabin"), "SC", "ST")
all_final_results$Group <- factor(all_final_results$Group, levels = c("SC", "ST"))
all_final_results$Algorithm <- factor(all_final_results$Algorithm, levels = c("CellChat", "CellphoneDB", "Nichenet", "Scriabin", "commot", "NICHES", "stlearn"))
...
base_dirs <- c(
  "D:/ATAC/HCLRs/GSE127465/CellChat",
  "D:/ATAC/HCLRs/GSE127465/CellphoneDB",
  "D:/ATAC/HCLRs/GSE127465/celltalker",
  "D:/ATAC/HCLRs/GSE127465/iTALK",
  "D:/ATAC/HCLRs/GSE127465/Nichenet",
  #"D:/ATAC/HCLRs/GSE127465/Scriabin",
  "D:/ATAC/HCLRs/GSE179572/commot",
  "D:/ATAC/HCLRs/GSE179572/NICHES"     #,"D:/ATAC/HCLRs/GSE179572/stlearn"
)
...
p
# save to PDF
ggsave(filename = "D:/ATAC/HCLRs/GSE127465/LUAD_benchmark_TOP_N_percent.pdf", p, width = 16, height = 6, units = "in")
...
p <- ggplot(all_final_results, aes(x = N, y = Value, color = Method)) +
  ...
  scale_x_continuous(
    trans = "log10",  # use log scale
    breaks = thresholds,
    labels = scales::comma_format()  # format large numbers
  ) +
  scale_color_manual(values = c("default" = "#ff7700", "hclr" = "#7084e7")) +
  labs(title = "", x = "Top Interactions Count (log scale)", y = "") +
  theme_bw(base_size = 14) +
...
p
# save to PDF
ggsave("D:/ATAC/HCLRs/GSE127465/LUAD_benchmark_TOP_N.pdf", p, width = 16, height = 6, units = "in")
...
method_paths <- list(
  CellChat = "D:/ATAC/HCLRs/GSE127465/CellChat",
  CellPhoneDB = "D:/ATAC/HCLRs/GSE127465/CellPhoneDB",
  celltalker = "D:/ATAC/HCLRs/GSE127465/celltalker",
  iTALK = "D:/ATAC/HCLRs/GSE127465/iTALK/",
  Nichenet = "D:/ATAC/HCLRs/GSE127465/Nichenet",
  commot = "D:/ATAC/HCLRs/GSE179572/commot",
  NICHES = "D:/ATAC/HCLRs/GSE179572/NICHES"
)
...
for (method_name in names(method_paths)) {
  ...
  # get all sample files for this method
...
# save plot
ggsave(filename = "D:/ATAC/HCLRs/GSE127465/LUAD_method_comparison_boxplot.pdf",gb, width = 8, height = 4)
